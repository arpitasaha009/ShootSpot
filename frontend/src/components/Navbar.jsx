...
const Navbar = () => {
  ...
  // Check if user is an photographer or admin
  const isArtist = user?.role === 'photographer';
  ...
  return (
    <nav className="flex justify-between items-center px-8 py-4 bg-black/80 text-white">
      ...
      <div className="flex gap-4">
        ...
        {/* Only show Collaboration Hub button if user is authenticated and is an photographer */}
