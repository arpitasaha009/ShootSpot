...
const ProductManagement = () => {
    ...
    const categories = ["Camera Equipment", "Lenses", "Lighting Equipment", "Light Modifiers", "Camera Support", "Background & Backdrops", "Power & Accessories", "Audio Accessories", "Studio Furniture", "Props & Styling", "Storage & Maintenance"];
    const brands = [
       "Canon","Nikon","Sony","Fujifilm","Panasonic","Sigma","Tamron","Godox","Profoto","Elinchrom","Manfrotto","Gitzo","DJI","Zhiyun","Aputure","Nanlite","Rode","Sennheiser","Neewer","SmallRig"
    ];
