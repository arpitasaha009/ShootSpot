            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <select
                  ...
                  required
                >
                  <option value="practice">Potrait Studio</option>
                  <option value="studio">Filming Studio</option>
                </select>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Camera, Tripod, Reflector"
                  className="w-full bg-gray-800 border border-gray-700 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
              </div>
              ...
              {studios.map((studio) => (
                <tr key={studio._id} className="hover:bg-gray-800/50">
                  ...
                  <td className="px-4 py-3 text-sm">
                    {studio.type === 'practice' ? 'Potrait Studio' : 'Filming Studio'}
                  </td>
