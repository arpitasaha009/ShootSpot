        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <FaCamera size={64} className="text-white" />
            </div>
              <h2 className="text-3xl font-bold mb-4 text-center">Book Studio</h2>
              <p className="text-center text-gray-300">
                Reserve studio time for your photography, content creation, or production needs
              </p>
            </div>
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-4 text-center">Rent Equipment</h2>
              <p className="text-center text-gray-300">
                Browse and rent high-quality equipments for upgrading your photography skills
              </p>
            </div>
          </div>
        </div>
