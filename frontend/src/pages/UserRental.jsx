  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-12">My Equipment Rentals</h1>
        ...
        {rentals.length === 0 ? (
          <div className="bg-gray-800 p-8 rounded-lg text-center">
            <div className="text-6xl mb-4"><FaCamera size={64} className="text-white" /></div>
            <h2 className="text-2xl font-bold mb-4">No Rentals Found</h2>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              You haven't rented any equipments yet. Start by browsing our collection and finding the perfect equipment for your needs.
            </p>
            <button
              ...
              <div key={rental._id} className="bg-gray-800 rounded-lg overflow-hidden">
                <div className="p-6">
                  <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                    <div>
                      <h2 className="text-2xl font-semibold">{rental.equipment.name}</h2>
                      <p className="text-gray-400">{rental.equipment.type} • {rental.equipment.brand}</p>
                    </div>
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white">${rental.totalAmount.toFixed(2)} ({rental.totalDays} days @ ${rental.equipment.dailyRate}/day)</p>
                    </div>
                  </div>
