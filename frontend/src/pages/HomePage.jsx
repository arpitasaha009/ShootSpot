...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "You earn points by booking practice/recording sessions and purchasing/renting equipments. Points categorize you into Bronze (5% discount), Silver (10% discount), Gold (15% discount), or Platinum (20% discount)."
  },
  {
    question: "How can I collaborate with other photographers?",
    answer: "Visit our Photographer Collaboration Hub where you can post and comment to connect with other photographers for jam sessions."
  },
  {
    question: "Can I rent equipments?",
    answer: "Yes, we offer equipment rental options. Browse our rental catalog and select the equipments you need for your practice sessions."
  }
];
    ...
    <div className="flex flex-col min-h-screen bg-cover bg-center text-white" style={{ backgroundImage: "url('piano-background.jpg')" }}>
      ...
      <div className="flex-1 flex flex-col justify-between p-8">
        <div className="mt-16">
          <h1 className="text-5xl font-bold leading-tight">
            A <br/>ONE STOP <br/>PHOTOGRAPHY SOLUTION
          </h1>
          <p className="mt-4 text-xl">
            Your ultimate destination for studio bookings, equipment shopping, and photographer collaboration.
          </p>
      ...
      <footer className="bg-black bg-opacity-50 text-center p-4">
        <div className="flex justify-center space-x-6 mb-4">
          <a href="https://instagram.com/shootspot" target="_blank" rel="noopener noreferrer" className="text-white hover:text-pink-400">
            <i className="fab fa-instagram text-xl"></i> Instagram
          </a>
          <a href="https://youtube.com/shootspot" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500">
